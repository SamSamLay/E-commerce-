...
<section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12 bg-[url(./images/EDKA_website_cover.png)]">
...
<div class="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-96 ml-auto">
  <div class="p-4 bg-teal-50">
    <p class="btn btn-ghost text-xl">Cozy<span class="text-xl">&reg;</span></p>
 ...
 <br>
    <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Buy Now</button>
  </div>
</div>
</section>
...
<div class="grid grid-cols-3 gap-4 p-4 w-full h-screen">
    <div class="w-full h-full">
        <img src="https://img.daisyui.com/images/stock/photo-1559703248-dcaaec9fab78.webp"
            alt="Burger" class="w-full h-full object-cover rounded-xl shadow-lg" />
    </div>
    <div class="w-full h-full">
