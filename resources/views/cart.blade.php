...
<div class="w-[1440px] h-[900px] relative bg-white overflow-hidden">
  ...
  @csrf
        <div class="w-[820px] h-40 left-[80px] top-[257px] absolute">
          <div class="h-[52px] p-4 left-[196px] top-[98px] absolute rounded border border-[#a2a3b1] justify-start items-center gap-10 inline-flex">
            <div data-svg-wrapper class="relative">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.16663 10H15.8333" stroke="#17183B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            </div>

            <!--1-->
            <div class="text-[#17183b] text-xl font-semibold font-['Proxima Nova'] leading-normal tracking-tight">1</div>
            <div data-svg-wrapper class="relative">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 4.16666V15.8333" stroke="#17183B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M4.16663 10H15.8333" stroke="#17183B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            </div>
          </div>
  ...
  <div class="w-[820px] h-40 left-[80px] top-[482px] absolute">
    ...
    <div class="h-[52px] p-4 left-[196px] top-[98px] absolute rounded border border-[#a2a3b1] justify-start items-center gap-10 inline-flex">
      ...
      <div data-svg-wrapper class="relative">
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 4.16669V15.8334" stroke="#17183B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M4.16663 10H15.8333" stroke="#17183B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      </div>
    </div>
